...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-black text-slate-800 tracking-tight">Business Overview</h1>
        <p className="text-slate-500 font-medium text-sm mt-1">Here's what's happening in your business today.</p>
      </div>
